...
public class ApertureEntities {
    ...
    public static final EntityType<AperturePortal> APERTURE_PORTAL = Registry.register(
            Registries.ENTITY_TYPE, Identifier.of(ApertureCraft.MOD_ID, "aperture_portal"),
    ...
    public static final EntityType<GhostBlockEntity> GHOSTBLOCK = Registry.register(
            Registries.ENTITY_TYPE, Identifier.of(ApertureCraft.MOD_ID, "ghostblock"),
    ...
    public static final EntityType<HighEnergyPelletEntity> HIGH_ENERGY_PELLET = Registry.register(
            Registries.ENTITY_TYPE, Identifier.of(ApertureCraft.MOD_ID, "high_energy_pellet"),
    ...
    public static final EntityType<RadioEntity> RADIO = Registry.register(Registries.ENTITY_TYPE,
            Identifier.of(ApertureCraft.MOD_ID, "radio"), EntityType.Builder
                    .create(RadioEntity::new, SpawnGroup.MISC).dimensions(1.0f, 1.0f).build());

    public static final EntityType<StorageCubeEntity> RUSTY_STORAGE_CUBE = Registry.register(
            Registries.ENTITY_TYPE, Identifier.of(ApertureCraft.MOD_ID, "rusty_storage_cube"),
    ...
    public static final EntityType<StorageCubeEntity> STORAGE_CUBE = Registry.register(
            Registries.ENTITY_TYPE, Identifier.of(ApertureCraft.MOD_ID, "storage_cube"),
            EntityType.Builder.create(StorageCubeEntity::new, SpawnGroup.MISC)
                    .dimensions(1.0f, 1.0f).build());

    public static final EntityType<StorageCubeEntity> OLD_STORAGE_CUBE = Registry.register(
            Registries.ENTITY_TYPE, Identifier.of(ApertureCraft.MOD_ID, "old_storage_cube"),
            EntityType.Builder.create(StorageCubeEntity::new, SpawnGroup.MISC)
                    .dimensions(1.0f, 1.0f).build());

    public static final EntityType<StorageCubeEntity> COMPANION_CUBE = Registry.register(
            Registries.ENTITY_TYPE, Identifier.of(ApertureCraft.MOD_ID, "companion_cube"),
            EntityType.Builder.create(StorageCubeEntity::new, SpawnGroup.MISC)
                    .dimensions(1.0f, 1.0f).build());

    public static final EntityType<TurretEntity> TURRET = Registry.register(Registries.ENTITY_TYPE,
            Identifier.of(ApertureCraft.MOD_ID, "turret"), EntityType.Builder
                    .create(TurretEntity::new, SpawnGroup.MISC).dimensions(1.0f, 1.0f).build());

    public static final EntityType<RocketTurretEntity> ROCKET_TURRET = Registry.register(
            Registries.ENTITY_TYPE, Identifier.of(ApertureCraft.MOD_ID, "rocket_turret"),
    ...
    public static final EntityType<PortalProjectileEntity> PORTAL_PROJECTILE = Registry.register(
            Registries.ENTITY_TYPE, Identifier.of(ApertureCraft.MOD_ID, "portal_projectile"),
            EntityType.Builder.create(PortalProjectileEntity::new, SpawnGroup.MISC)
                    .dimensions(.5f, .5f).build());

    public static final EntityType<FloatingPanelEntity> FLOATING_PANEL = Registry.register(
            Registries.ENTITY_TYPE, Identifier.of(ApertureCraft.MOD_ID, "floating_panel"),
            EntityType.Builder.create(FloatingPanelEntity::new, SpawnGroup.MISC)
