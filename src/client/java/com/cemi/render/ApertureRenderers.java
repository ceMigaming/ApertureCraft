...
import com.cemi.render.entity.RocketTurretRenderer;
...
public class ApertureRenderers {
        ...
        public static void registerRenderers() {
                EntityRendererRegistry.register(ApertureEntities.GHOSTBLOCK,
                                GhostBlockRenderer::new);
                EntityRendererRegistry.register(ApertureEntities.RUSTY_STORAGE_CUBE,
                                RustyStorageCubeRenderer::new);
                EntityRendererRegistry.register(ApertureEntities.STORAGE_CUBE,
                                StorageCubeRenderer::new);
                ...
                EntityRendererRegistry.register(ApertureEntities.ROCKET_TURRET,
                                RocketTurretRenderer::new);
        }
